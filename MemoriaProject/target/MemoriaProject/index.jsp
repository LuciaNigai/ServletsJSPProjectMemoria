...
<body>
	...
	<section class="add-new" id="add">
		...
		<p>
			You can create a new folder to store the cards. <br>You can
			create an entire course and add later different folders to it.<br>You
			can create a new card, adding it to an already existing folder.
		</p>
		<div class="row">
